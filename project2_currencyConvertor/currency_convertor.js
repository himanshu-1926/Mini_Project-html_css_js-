const country_list = {
    ...
    "BND": "BN", "BOB": "BO", "BRL": "BR", "BSD": "BS", "BWP": "BW", "BYN": "BY",
    "BZD": "BZ", "CAD": "CA", "CDF": "CD", "XAF": "CF", "CHF": "CH", "CLP": "CL",
    "CNY": "CN", "COP": "CO", "CRC": "CR", "CUP": "CU", "CVE": "CV", "CZK": "CZ",
    "DJF": "DJ", "DKK": "DK", "DOP": "DO", "DZD": "DZ", "EGP": "EG", "ETB": "ET",
    "EUR": "FR", "FJD": "FJ", "FKP": "FK", "GBP": "GB", "GEL": "GE", "GHS": "GH",
    ...
    "MOP": "MO", "MRO": "MR", "MUR": "MU", "MVR": "MV", "MWK": "MW", "MXN": "MX",
...
const dropList = document.querySelectorAll("select"),
    fromCurrency = document.querySelector(".from-box select"),
    toCurrency = document.querySelector(".to-box select"),
    getButton = document.querySelector("button");
    const amountInput = document.querySelector("#amount-input");

// Populate selects and add change event
...
function loadFlag(element) {
    ...
    imgTag.src = `https://flagcdn.com/w80/${country_list[code].toLowerCase()}.png`;
}
...
async function getExchangeRate() {
    ...
    try {
        ...
        exchangeRateTxt.innerText = `${amountVal} ${fromCode.toUpperCase()} = ${totalAmount} ${toCode.toUpperCase()}`;
    } catch (error) {
        exchangeRateTxt.innerText = "Error fetching data. Try again.";
    }
}
